...
using abp_7_2_2.MauiBlazor.Navigation;
...
namespace abp_7_2_2.MauiBlazor;
    ...
    [DependsOn(
        ...
        typeof(abp_7_2_2HttpApiClientModule),
        typeof(AbpGdprBlazorModule)
        )]
public class abp_7_2_2MauiBlazorModule : AbpModule
{
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new abp_7_2_2MenuContributor(context.Services.GetConfiguration()));
        });
    }

    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        Configure<AbpRouterOptions>(options => { options.AppAssembly = typeof(abp_7_2_2MauiBlazorModule).Assembly; });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<abp_7_2_2MauiBlazorModule>();
        });
    }
